        ...
        return this.props.stepList.map((stepItem, i) => {
            ...
            return (
                <View key={i} style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
                    {item}
                    {this.props.stepList.length > (i + 1) &&
                    <View style={{height: 3, width: window.width / 10, backgroundColor: '#d0d0d0', marginTop: -15}}/>}
                </View>
...
//渲染
    render() {
        return (
            <View
                style={{backgroundColor: '#fff', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
