        ...
        return (
            <View style={{borderBottomWidth: 0.5, borderColor: '#ccc', padding: 10}}>
                ...
                <View style={{flexDirection: 'row', paddingTop: 10}}>
                    ...
                    {(item.task_status == 2 || item.task_status == 1) &&
                ...
                <View style={{paddingTop: 10}}>
                    <Text
                        style={[globalStyles.smallText, {color: '#8b959b'}]}>计划运送时间：{item.plan_date ? moment(`${item.plan_date}`).format('YYYY-MM-DD HH:mm:ss') : ''}</Text>
                </View>
            </View>
        )
    }
                ...
                <View style={{flex: 1}}>
                    ...
                    <View style={{flexDirection: 'row', paddingTop: 10}}>
                        ...
                        <Text style={[globalStyles.smallText, {
                            ...
                            textAlign: 'center',
                            flex: 1
                        }]}>实际运送：<Text style={{color: styleColor}}>{item.car_count ? item.car_count : '0'}</Text></Text>
                        <Text style={[globalStyles.smallText, {color: '#8b959b', textAlign: 'right', flex: 1}]}>
