...
import SearchCleanRel from '../modules/SearchCleanRel'
...
const mapDispatchToProps = (dispatch) => ({
    getCleanRelListMore: () => {
        dispatch(actions.cleanRelListAction.getCleanRelListMore())
    },
    getReceive: req => {
        dispatch(actions.receiveForCleanRelActions.getReceive(req))
    },
    getReceiveWaiting: () => {
        dispatch(actions.receiveForCleanRelActions.getReceiveWaiting())
    }
})
