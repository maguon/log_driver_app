            ...
            <Content>
                <View style={{ padding: 15, backgroundColor: '#f2f6f9' }}>
                    <View style={{ flexDirection: 'row' }}>
                        <View style={{ width: 40 }}>
                            <MaterialCommunityIcons name='truck-trailer' size={25} color={styleColor} />
                        </View>
                        <View style={{ flex: 1, flexDirection: 'row' }}>
                            <Text style={[globalStyles.largeText, { color: styleColor, fontWeight: 'bold' }]}>{trailerInfo.truck_num ? trailerInfo.truck_num : ''}</Text>
                        </View>
                        <View style={{ width: 40 }}>
                            {trailerInfo.operate_type == 1 && <FontTag size={30} title='自' color={styleColor} fontColor='#fff' />}
                            {trailerInfo.operate_type == 2 && <FontTag size={30} title='协' color={styleColor} fontColor='#fff' />}
                            {trailerInfo.operate_type == 3 && <FontTag size={30} title='供' color={styleColor} fontColor='#fff' />}
                            {trailerInfo.operate_type == 4 && <FontTag size={30} title='包' color={styleColor} fontColor='#fff' />}
                        </View>
                    </View>
