...
const ListHeader = () => {
    return (
        <View style={styles.header}>
            <Icon name='ios-paper' style={[styles.headerIcon, globalStyles.styleColor]} />
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <FlatList
                ...
                data={carInfoRecord ? carInfoRecord.comment : []}
...
export default connect(mapStateToProps, mapDispatchToProps)(RecordForDemage)
