...
export default handleActions({
    ...
    [actionTypes.initializationType.init_app_failed]: (state, action) => {
    ...
    [actionTypes.initializationType.init_app_error]: (state, action) => {
        const { payload: { currentStep, param, msg } } = action
        return {
            ...state,
            data: {
    ...
    [actionTypes.initializationType.init_app_complete]: (state, action) => {
