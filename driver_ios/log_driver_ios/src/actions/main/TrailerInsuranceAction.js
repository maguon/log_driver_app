...
export const getTrailerInsurance = () => async (dispatch, getState) => {
    try {
        ...
        if (res.success) {
            ...
            dispatch({ type: actionTypes.trailerInsuranceActionType.GET_TrailerInsurance_FAILED, payload: { data: res.msg } })
        }
...
export const getTrailerInsuranceWaiting = () => (dispatch) => {
    dispatch({ type: actionTypes.trailerInsuranceActionType.GET_TrailerInsurance_WAITING, payload: {} })
}
