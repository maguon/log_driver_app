...
export const getAccidentImageList = (param) => async (dispatch, getState) => {
    ...
    try {
        ...
        if (res.success) {
            dispatch({
                type: actionTypes.imageForAccidentType.get_AccidentImageList_success, payload: {
...
export const getAccidentImageListWaiting = () => (dispatch) => {
    dispatch({ type: actionTypes.imageForAccidentType.get_AccidentImageList_waiting, payload: {} })
}

export const uploadAccidentImageWaiting = () => (dispatch) => {
    dispatch({ type: actionTypes.imageForAccidentType.upload_ImageAtAccidentInfo_waiting, payload: {} })
}
