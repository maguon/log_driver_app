...
const mapDispatchToProps = (dispatch) => ({
    getSalaryListMore: () => {
        dispatch(reduxActions.salaryList.getSalaryListMore())
    },
    getSalaryTaskListWaiting: () => {
        dispatch(reduxActions.salary.getSalaryTaskListWaiting())
    },
    getSalaryTaskList: req => {
        dispatch(reduxActions.salary.getSalaryTaskList(req))
    }
})
