...
import * as taskLoanListAction from './taskLoanListAction'
        ...
        if (getTaskLoanList.isResultStatus == 1) {
            ...
            return (
                <FlatList
                    ...
                    ListFooterComponent={taskLoanListReducer.getTaskLoanListMore.isResultStatus == 1 ? ListFooterComponent : <View style={{ height: 10 }} />}
...
const mapDispatchToProps = (dispatch, ownProps) => ({
    getTaskLoanListMore: () => {
        dispatch(taskLoanListAction.getTaskLoanListMore())
    },
