...
export default handleActions({
    ...
    [actionTypes.imageForAccidentTypes.get_AccidentImageList_failed]: (state, action) => {
    ...
    [actionTypes.imageForAccidentTypes.get_AccidentImageList_waiting]: (state, action) => {
        return {
            ...state,
            getAccidentImageList: {
                ...initialState.getAccidentImageList,
    ...
    [actionTypes.imageForAccidentTypes.get_AccidentImageList_error]: (state, action) => {
    ...
    [actionTypes.imageForAccidentTypes.upload_ImageAtAccidentInfo_success]: (state, action) => {
    ...
    [actionTypes.imageForAccidentTypes.upload_ImageAtAccidentInfo_partSuccess]: (state, action) => {
    ...
    [actionTypes.imageForAccidentTypes.upload_ImageAtAccidentInfo_waiting]: (state, action) => {
        return {
            ...state,
            uploadAccidentImage: {
                ...initialState.uploadAccidentImage,
    ...
    [actionTypes.imageForAccidentTypes.upload_ImageAtAccidentInfo_failed]: (state, action) => {
        const { payload: { failedMsg } } = action
        return {
            ...state,
            uploadAccidentImage: {
    ...
    [actionTypes.imageForAccidentTypes.upload_ImageAtAccidentInfo_error]: (state, action) => {
        const { payload: { errorMsg } } = action
        return {
            ...state,
            uploadAccidentImage: {
