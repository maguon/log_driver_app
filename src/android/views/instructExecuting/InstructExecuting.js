                    ...
                    <View style={{ flex: 1 }}>
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <Text style={[globalStyles.midText, { color: '#8b959b', fontWeight: 'bold' }]}>{item.addr_name ? item.addr_name : ''} --> {item.city_name ? item.city_name : ''} - {item.short_name ? item.short_name : ''}</Text>
                            </View>
                        </View>
            ...
            return (
                <View style={{ borderBottomWidth: 0.5, borderColor: '#ccc', padding: 10 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Text style={[globalStyles.midText, { fontSize: 15, color: '#8b959b', fontWeight: 'bold' }]}>{item.addr_name ? item.addr_name : ''}</Text>
                            <MaterialCommunityIcons name='ray-start-arrow' size={20} style={{ paddingLeft: 5, color: '#8c989f' }} />
                            <Text style={[globalStyles.midText, { color: '#8b959b', fontWeight: 'bold', paddingLeft: 5 }]}>{item.city_name ? item.city_name : ''}{item.short_name ? `(${item.short_name})` : ''}</Text>
                        </View>
